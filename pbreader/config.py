...
class Config:
    ...
    #: Опрашивать аппарат по сети (SNMP): счётчик отпечатанных листов, бумага в
    #: лотках, тонер, замятия. Работает только при сетевом подключении принтера.
    snmp_enabled: bool = True
    #: Community для чтения. На аппаратах из коробки обычно "public".
    snmp_community: str = "public"
    #: Адрес принтера. Пусто — определяется по его порту в Windows.
    snmp_host: str = ""
